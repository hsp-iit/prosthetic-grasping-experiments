...
def main(args):
    ...
    with torch.set_grad_enabled(False):
        ...
        for batch_idx, (frames, perframe_grasp_type, perframe_preshape, 
            ...
            perframe_wrist_ps = perframe_wrist_ps.squeeze(0)
            perframe_preshape_wrist_ps = perframe_preshape_wrist_ps.squeeze(0)

            if args.output in ['wrist_ps', 'preshape_wrist_ps']:
                frames = frames[:FRAMES_THRESHOLD]
                perframe_grasp_type = perframe_grasp_type[:FRAMES_THRESHOLD]
                perframe_preshape = perframe_preshape[:FRAMES_THRESHOLD]
